...
export default function Laporan() {
  ...
  const [activeTab, setActiveTab] = useState<"Bulanan" | "Tunggakan" | "Rekapitulasi" | "Tahunan">("Tahunan");
  ...
  const exportCSV = () => {
    if (activeTab === "Bulanan") {
      ...
      downloadBlob(csv, `Daftar_Tunggakan_${filterMonth}_${filterYear}.csv`);
        ...
        // TAHUNAN EXPORT COULD GO HERE
        alert("Gunakan tombol 'Print Laporan' atau Cetak (Ctrl+P) untuk laporan tahunan.");
    }
  };
      ...
      <div className="print:hidden flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 border-b border-gray-100 pb-4">
        ...
        <div className="flex flex-wrap gap-2 bg-gray-100 p-1.5 rounded-xl border border-gray-200">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${activeTab === "Bulanan" ? "bg-white text-gray-900 shadow border border-gray-200" : "text-gray-500 hover:text-gray-700"}`}
          >
            Bulanan
          </button>
          <button
            onClick={() => setActiveTab("Tunggakan")}
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${activeTab === "Tunggakan" ? "bg-white text-brand-700 shadow border border-brand-200" : "text-gray-500 hover:text-gray-700"}`}
          >
            Tunggakan
          </button>
          <button
            onClick={() => setActiveTab("Rekapitulasi")}
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${activeTab === "Rekapitulasi" ? "bg-white text-blue-700 shadow border border-blue-200" : "text-gray-500 hover:text-gray-700"}`}
          >
            Rekap Warga
          </button>
          <button
            onClick={() => setActiveTab("Tahunan")}
            className={`px-4 py-2 text-sm font-bold rounded-lg transition-all ${activeTab === "Tahunan" ? "bg-brand-600 text-white shadow border border-brand-700" : "text-gray-500 hover:text-gray-700"}`}
          >
            Tahunan
          </button>
        </div>
      ...
      {activeTab === "Tahunan" && (
        <div className="bg-white mx-auto border-2 border-gray-300 print:border-none print:shadow-none shadow-sm pb-8 mb-12">
            <div className="text-center py-6 border-b-2 border-gray-300 bg-gray-50/50 print:bg-transparent">
                ...
                <h3 className="font-bold text-lg text-gray-800 tracking-wide mt-1">Suka Duka Gang Jepun</h3>
            ...
            <div className="overflow-x-auto print:overflow-visible p-6">
                ...
                <tbody>
                    ...
                    <td className="py-4 px-4 border-2 border-gray-400 font-extrabold text-brand-950 uppercase tracking-wider text-sm">TOTAL KAS SUKA DUKA</td>
            ...
            {categoryBreakdown.length > 0 ? (
              <div className="space-y-4">
                {categoryBreakdown.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex justify-between items-center p-3 rounded-xl border border-gray-50 hover:bg-gray-50 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      <div
             ...
             <div className="overflow-x-auto print:overflow-visible">
               <table className="w-full text-left font-mono text-xs whitespace-nowrap border-collapse">
                 <thead className="bg-gray-100 border-b-2 border-gray-200">
                    <tr>
                       <th className="px-4 py-3 sticky left-0 z-10 bg-gray-100 border-r border-gray-200 w-12 text-center uppercase tracking-widest text-gray-500 font-bold">Blok</th>
                       <th className="px-4 py-3 sticky left-12 z-10 bg-gray-100 border-r border-gray-200 uppercase tracking-widest text-gray-500 font-bold">Nama Warga</th>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="text-gray-500 font-medium bg-gray-50 border-b border-gray-100">
                <tr>
                  <th className="px-6 py-4">Nomor Rumah</th>
                  <th className="px-6 py-4">Kepala Keluarga</th>
                  <th className="px-6 py-4 text-center">
                    Estimasi Nunggak (Tahun Ini)
                  </th>
                  <th className="px-6 py-4 text-right">Aksi Tindak Lanjut</th>
                </tr>
              </thead>
